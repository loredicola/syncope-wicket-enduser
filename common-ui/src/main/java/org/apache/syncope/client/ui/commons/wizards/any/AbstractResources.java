...
public abstract class AbstractResources extends Panel {

    private static final long serialVersionUID = 552437609667518888L;

    protected final ListModel<String> available;

    public <T extends AnyTO> AbstractResources(final String id, final AnyWrapper<T> modelObject) {
        super(id);
        ...
        this.available = new ListModel<>(new ArrayList<>());
