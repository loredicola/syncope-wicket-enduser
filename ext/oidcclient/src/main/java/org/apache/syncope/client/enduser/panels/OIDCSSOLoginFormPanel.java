...
public class OIDCSSOLoginFormPanel extends BaseSSOLoginFormPanel {
    ...
    public OIDCSSOLoginFormPanel(final String id) {
        ...
        List<OIDCProviderTO> available =
                SyncopeEnduserSession.get().getAnonymousClient().getService(OIDCProviderService.class).list();
        ...
        ops.setChoiceRenderer(new IChoiceRenderer<OIDCProviderTO>() {
            ...
            @Override
            public OIDCProviderTO getObject(
                    final String id, final IModel<? extends List<? extends OIDCProviderTO>> choices) {
